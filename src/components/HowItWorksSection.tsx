            ...
            {steps.map((step, index) => (
              ...
              >
                ...
                {index % 2 === 0 ? ( // Even index: Left side
                  <>
                    <Card className={cn(
                      "w-full md:w-[calc(50%-16px)] p-6 shadow-lg shadow-[0_0_25px_rgba(173,216,230,0.3)] transition-all duration-300 bg-indigo-950 text-white", // Changed to bg-indigo-950 and text-white
                      ...
                      <CardContent className="p-0">
                        <CardDescription className="text-indigo-100"> {/* Adjusted description text color */}
                          {step.description}
                        </CardDescription>
                      </CardContent>
                    </Card>
