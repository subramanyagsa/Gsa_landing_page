      ...
      <div className="container px-4 md:px-6 max-w-6xl mx-auto text-center">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          {painPoints.map((point, index) => (
            ...
            >
              {/* Enhanced soft fading glow effect */}
              <div className="absolute inset-[-10px] rounded-lg bg-conic-gradient-purple-blue animate-pulse-glow opacity-100 blur-xl z-[-1]"></div>
